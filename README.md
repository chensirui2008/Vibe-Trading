...
<details>
<summary><b>Finance Skill Library</b> <sub>94 skills across 9 categories</sub></summary>

- 📊 94 specialized finance skills organized into 9 categories
...
All 94 finance skills are published on [open-space.cloud](https://open-space.cloud) and evolve autonomously through OpenSpace's self-evolution engine.
...
OpenSpace will auto-discover all 94 skills, enabling auto-fix, auto-improve, and community sharing. Search for Vibe-Trading skills via `search_skills("finance backtest")` in any OpenSpace-connected agent.
...
│   │   │   ├── skills.py           #   skill loader (94 bundled + user-created via CRUD)
...
│   │   │
│   │   ├── skills/                 # 94 finance skills in 9 categories (SKILL.md each)
