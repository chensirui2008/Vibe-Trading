...
<details>
<summary><b>مكتبة المهارات المالية</b> <sub>94 مهارة عبر 9 فئات</sub></summary>

- 📊 94 مهارة مالية متخصصة منظمة في 9 فئات
...
كل المهارات المالية الـ 94 منشورة على [open-space.cloud](https://open-space.cloud) وتتطور ذاتياً عبر محرك التطور الذاتي في OpenSpace.
...
سيكتشف OpenSpace كل المهارات الـ 94 تلقائياً، مما يتيح auto-fix وauto-improve والمشاركة المجتمعية. ابحث عن مهارات Vibe-Trading عبر `search_skills("finance backtest")` في أي وكيل متصل بـ OpenSpace.
