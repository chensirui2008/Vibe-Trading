...
<details>
<summary><b>Biblioteca de Skills Financieras</b> <sub>94 skills en 9 categorías</sub></summary>

- 📊 94 skills financieras especializadas organizadas en 9 categorías
...
Los 94 skills de finanzas están publicados en [open-space.cloud](https://open-space.cloud) y evolucionan de forma autónoma mediante el motor de auto-evolución de OpenSpace.
...
OpenSpace descubrirá automáticamente los 94 skills, habilitando auto-fix, auto-improve y compartición comunitaria. Busca skills de Vibe-Trading mediante `search_skills("finance backtest")` en cualquier agente conectado a OpenSpace.
...
│   │   │   ├── skills.py           #   cargador de skills (94 incluidas + creadas por el usuario vía CRUD)
...
│   │   │
│   │   ├── skills/                 # 94 skills financieras en 9 categorías (un SKILL.md cada una)
